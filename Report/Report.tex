...
This procedure is repeated until the coefficients converge, yielding the final estimates $(\mu,\beta,\gamma)$ and scores $W_i$. See Algorithm~\ref{alg:fit-svm-lasso}.
...
obtain the final L2-SVM fit. See Algorithm~\ref{alg:gcv-tuning}.
