...
\begin{titlepage}
  ...
  \textbf{Chengyuan}: \ldots \textbf{Daniel}: \ldots \textbf{Junjie} \ldots
\end{titlepage}
...
\newpage
\appendix
\section{Appendix} Table~\ref{tab:GerberGreen} and Table~\ref{tab:LaLonde} provide previews of the analyzed datasets. 
