...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{figs/GerberGreenTreatments.png}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=.9\textwidth]{figs/GerberGreenControls.png}
...
\texttt{marr} \ldots
\texttt{nodegr} \ldots
\texttt{log.re75} \ldots
\texttt{u75} \ldots
\texttt{wts.extrap} \ldots
