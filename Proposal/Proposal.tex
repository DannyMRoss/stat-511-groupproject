...
To evaluate the proposed model's ability to achieve the above objectives the authors' apply their model to analyze two well-known randomized evaluation studies in the social sciences. 
...
Including the dataset \texttt{GerberGreen}, which is data from the 1998 New Haven Get-Out-the-Vote filed experiment where many different mobilization techniques were randomly administered to votes in the 1998 election.
...
Both datasets include binary outcome variables, treatment fields (either categorical or binary), and demographic covariates. 
